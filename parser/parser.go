...
// precedences in monkeylang
// here just the order matters
const (
	_ int = iota
	LOWEST
	EQUALS      // ==
...
// precedence table and few helper methods
...
//types defines for functions: prefixparsing and infixparsing
...
func New(l *lexer.Lexer) *Parser {
	...
	//adding tokens for plus and minus
...
//extending the parse and the parseExpression method to give us better error
